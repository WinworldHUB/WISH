  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-xl-2 col-9">
              <div className="logo">
                <a href="index.html">
                  <img
                    src="/src/assets/img/site-logo/logo-black.png"
                    alt="enpix"
                  />
                </a>
              </div>
      ...
      <main>
        ...
        {/* <section className="splide banner-slider" id="bannerslider">
          ...
          <div className="splide__arrows">
            ...
            >
              ...
              >
                <path
                  d="M4 1.28906L1.5 3.78906L4 6.28906M16.5 3.78906H1.5H16.5Z"
                  stroke-width="1.5"
            ...
            >
              ...
              >
                <path
                  d="M14 6.28906L16.5 3.78906L14 1.28906M1.5 3.78906H16.5H1.5Z"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
        ...
        <section className="services-area pb-130 relative">
          <div className="container">
        ...
        <section className="speciality-area ">
          <div className="container">
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-7 offset-xl-1">
                ...
                <div className="splide" id="reviewSlider">
                  <div className="splide__track">
                    <ul className="splide__list">
                      <li className="splide__slide">
                        <div className="reviews-container">
                          <div className="review-text">
                            <p>
                              5 stars design agency! If anyone wants an example
                              of what you can do with this theme, check out my
                              site at artishthemes.com.
                            </p>
                          </div>
                  ...
                  <div className="splide__arrows mt-80">
                    <button
                      type="button"
                      title="Button"
                      className="splide__arrow splide__arrow--prev"
